...
export const SendMailForm = (props) => {
  ...
  return (
    <>
      ...
      {messageSuccess ? (
        <p className="font-thin my-2 mx-5 text-turquoise italic">
        ...
        >
          <div className="flex">
            ...
            <textarea
              className="border px-2 h-22 font-thin  focus:outline-none focus:border-turquoise focus:border-2 focus:border-solid rounded-md w-full ms-2 mb-5"
              {...register("message", {
          ...
          <div>
            <label className="font-thin my-2 me-3" for="includeSender">
              Do you want to receive a copy of email?
            </label>
            <input
